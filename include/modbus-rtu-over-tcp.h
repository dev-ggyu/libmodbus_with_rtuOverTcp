 ...
 */
#define MODBUS_RTUTCP_MAX_ADU_LENGTH  260
...
MODBUS_API int modbus_rtutcp_accept(modbus_t* ctx, int* s);
...
MODBUS_API int modbus_rtutcp_pi_accept(modbus_t* ctx, int* s);
